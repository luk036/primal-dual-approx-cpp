...
/**
 * @brief minimum weigthed maximal independent set problem
 *
 * The function `min_maximal_independent_set` is solving the minimum maximal
 * independent set problem using the primal-dual paradigm.
 *
 * @tparam Graph
 * @tparam C1
 * @tparam C2
